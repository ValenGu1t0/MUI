    ...
    return (
        ...
        <nav className="flex flex-row p-4 bg-indigo-500 justify-between items-center shadow-md shadow-gray-300/70">
            ...
            <div className="flex flex-row items-center gap-4">
                ...
                <h2 className="font-bold text-2xl text-indigo-950" id="foodar">FoodAr</h2>
            </div>
            </Link>
            ...
            <ul className="flex flex-row gap-4">
                ...
                <li className="flex items-center gap-2 transition duration-200 text-indigo-950 hover:scale-105">
